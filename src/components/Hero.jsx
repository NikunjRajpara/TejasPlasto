          ...
          <div className="lg:col-span-5 flex items-stretch">
            <div className="w-full bg-white rounded-3xl border border-slate-200 p-3 shadow-sm relative overflow-hidden flex flex-col justify-center" id="hero-bento-right">
              ...
              <motion.div
                ...
                className="relative w-full h-full min-h-[300px] lg:min-h-0 aspect-[4/3] rounded-2xl overflow-visible bg-slate-100"
                id="hero-img-container"
              >
                <img
                  src="/src/assets/images/hero_water_tanks_1783423894442.jpg"
