...
export default function CompanyOverview() {
  const pillars = [
    ...
    },
    {
      ...
      desc: 'Ultrasonic wall thickness audits and hydrostatic compliance load checks guarantee optimal structural durability.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600">
            Tejas Plasto stands for uncompromising safety and robust strength. We transform high-density virgin food-grade polymer resins into industry-leading liquid storage containment systems.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch" id="about-bento-grid">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4 relative z-10">
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  <div className="w-9 h-9 rounded-full bg-slate-200 border-2 border-white flex items-center justify-center font-bold text-[10px] text-slate-600">IS</div>
                  <div className="w-9 h-9 rounded-full bg-slate-300 border-2 border-white flex items-center justify-center font-bold text-[10px] text-slate-600">ISO</div>
                  <div className="w-9 h-9 rounded-full bg-slate-400 border-2 border-white flex items-center justify-center font-bold text-[10px] text-slate-600">FDA</div>
                </div>
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl border border-slate-200 p-8 shadow-xs flex flex-col justify-between">
            <div className="space-y-6">
              <div className="flex justify-between items-center pb-2 border-b border-slate-100">
                ...
                <span className="text-[10px] text-slate-400 font-mono">STABILITY CORE</span>
              </div>
          ...
          <div className="lg:col-span-6 bg-[#F57C00] rounded-3xl p-8 text-white relative overflow-hidden flex flex-col justify-between shadow-lg group">
            ...
            <div className="mt-8 flex items-center justify-between gap-4 pt-6 border-t border-white/20 relative z-10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center font-display font-extrabold text-sm text-white border border-white/10">NT</div>
                <div>
                  <h4 className="font-display font-bold text-xs sm:text-sm">Nitin Tejas</h4>
