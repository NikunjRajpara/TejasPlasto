...
export const PRODUCTS = [
  ...
  },
  {
    id: "LLDPE Powder Bag",
    category: "Rotomoulding Powder",
    name: "LLDPE Rotomoulding Powder",
...
export const FEATURES= [
  ...
  },
  {
    id: 'f8',
    title: 'Long Warranty',
    description: 'We stand behind our manufacturing quality. Every Tejash Plasto tank comes backed by an industry-leading comprehensive warranty up to 7 years.',
    iconName: 'Award'
  }
];
...
export const TESTIMONIALS= [
  {
    ...
    rating: 5,
    review: 'We have been installing Tejash Plasto overhead and underground tanks in our high-rise luxury apartment projects across Gujarat for 6 years. Their structural strength, crack resistance under harsh summers and excellent dealer logistics have made them our default standard.',
  ...
  },
  {
    ...
    rating: 4,
    review: 'We have been sourcing rotomoulding powder from Tejash Plasto for our manufacturing unit. The powder quality is consistent, processing is smooth and the finished products have excellent strength and surface finish. A dependable supplier for our production needs.',
  ...
  },
  {
    ...
    rating: 5,
    review: 'We installed multiple 5,000-liter Tejash Plasto water tanks for our agricultural water storage requirements. The tanks are sturdy, easy to install and maintain excellent water quality. Their build quality and finish have exceeded our expectations.',
  ...
  },
  {
    ...
    rating: 4,
    review: 'For our residential construction project, we selected Tejash Plasto overhead water tanks because of their strong build quality and premium finish. Delivery was on time, installation was straightforward and the overall product quality has been excellent.',
...
export const GALLERY= [
  ...
  { id: 'g2', title: 'GI Tank', category:'plant', image: aquawingsfull, },
  ...
  { id: 'g5', title: 'LLDPE Rotomoulding Powder', category:'products', image: rotomouldingpowderbag, },
  { id: 'g6', title: 'Rotomoulding Powder', category:'products', image: rotomouldingpowderdish, },
  { id: "g7", title: "Manufacturing", category: "interior", image: factory },
  { id: "g8", title: "Rotomoulding Powder ", category: "interior", image: powderbag },
  { id: "g9", title: "Water Tanks", category: "interior", image: packedwatertank }
];
...
export const FAQS= [
  ...
  {
    id: 'faq2',
    question: 'What is the warranty period for Tejash Plasto tanks?',
