...
export const PRODUCTS= [
  {
    ...
    image: aquawings,
    layers: ['Outer UV Protection Layer', 'Strength-Enhancing Ribbed Layer', 'Insulation Layer (Heat Shield)', 'Chemical Resistance Layer', 'Anti-Bacterial Layer'],
    features: ['100% Virgin Plastic', 'Active Copper Anti-Bacterial Technology', 'Heavy-duty airtight threaded lid', 'Extreme weather & crack resistant', '10-Year Warranty'],
