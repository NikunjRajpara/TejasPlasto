        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="products-grid">
          {PRODUCTS.map((product) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-xs hover:shadow-xl transition-all flex flex-col group"
            >
              {/* Product Image */}
              <div className="relative h-80 flex items-center justify-center bg-white overflow-hidden">
                <img
                  src={product.image}
                  alt={product.name}
                  "w-full h-full object-contain scale-125 group-hover:scale-[1.3] transition-transform duration-500"
