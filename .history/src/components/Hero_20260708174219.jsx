          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-center p-8 sm:p-12" id="hero-bento-left">
            ...
            <div className="space-y-6 sm:space-y-8 relative z-10">
              ...
              <motion.p
                ...
                id="hero-subheading"
              >
                Tejash Plasto manufactures durable, UV-protected, 100% food-grade water storage tanks designed for homes, industries, agriculture and commercial systems. Engineered to last a lifetime.
              </motion.p>
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-emerald-500 font-bold">✓</span> 5-7 Year Warranty Shield
                </div>
              </motion.div>
            </div>
          </div>
