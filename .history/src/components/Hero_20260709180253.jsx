...
import { Sparkles, Sun, ShieldCheck, Droplets, Clock, ArrowRight, Beaker, } from "lucide-react";
					...
					<div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-center p-7">
						...
						<div className="space-y-5 relative z-10">
							...
							<motion.p
								...
								id="hero-subheading"
							>
								Tejash Plasto LLP manufactures premium-quality water storage tanks and rotomoulding powder using advanced rotational moulding technology. Built for durability, hygiene, and long-lasting performance.
							</motion.p>
						...
						<div className="w-full bg-white rounded-3xl border border-slate-200 p-3 shadow-sm relative overflow-hidden flex flex-col justify-center" id="hero-bento-right">
							...
							>
								<img
									...
									className="w-full h-full object-cover rounded-2xl transition duration-700 hover:scale-105"
