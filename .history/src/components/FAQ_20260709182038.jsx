...
export default function FAQ() {
	...
	return (
		<section id="faq" className="py-13 bg-white relative overflow-hidden">
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
					...
					<p className="text-slate-600">
						Have structural or installation questions? Browse through our technical guide or reach out to our support helpline.
					</p>
				</div>
				...
				<div className="space-y-4" id="faq-accordions">
					{FAQS.map((faq) => {
						...
						return (
							<div
								key={faq.id}
								className={`border rounded-3xl transition-all duration-300 ${isOpen
				...
				<div className="glass-card mt-12 p-6 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4 max-w-2xl mx-auto">
					...
					<Link
						to="/contact"
						className="btn-primary px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap"
					>
