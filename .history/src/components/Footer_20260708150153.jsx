...
export default function Footer() {
  ...
  const productLinks = [
    ...
    { name: 'Agricultural Tanks', href: '#products' },
    { name: 'Industrial Tanks', href: '#products' },
    { name: 'Chemical Storage Tanks', href: '#products' },
  ];
  ...
  const quickLinks = [
    ...
    { name: 'Our Dealer Network', href: '#dealers' },
    ...
    <footer className="bg-[#0E1726] text-slate-300 font-sans" id="app-footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12" id="footer-columns">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
              Tejas Plasto manufactures premium, durable, UV-protected, 100% food-grade water storage containment systems. Providing water security to homes, fields, and factories since 2016.
            </p>
            ...
            <div className="flex items-center gap-3" id="footer-socials">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-8 h-8 rounded-lg bg-white/5 hover:bg-primary hover:text-white flex items-center justify-center transition-all"
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-3.5 text-xs text-slate-400">
              <li className="flex items-start gap-2.5">
                ...
                <span>
                  GIDC Phase II, Vatva, Ahmedabad, Gujarat - 382445
                </span>
              </li>
      ...
      <div className="border-t border-white/5 bg-slate-950/40 text-slate-500 py-6 text-xs text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© {currentYear} Tejas Plasto Industries. All rights reserved. Built with premium quality.</p>
          <div className="flex gap-4">
            ...
            <span>•</span>
            <a href="#about" className="hover:text-slate-400 transition-colors">ISO Standards</a>
          </div>
        </div>
      </div>
    </footer>
