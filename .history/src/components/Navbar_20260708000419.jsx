					...
					>
						<div className="flex items-center justify-between pb-6 border-b border-slate-100">
							<div className="flex items-center gap-2">
								...
								<span className="font-display font-bold text-lg text-slate-900">Tejas Plasto</span>
							</div>
							<button
								onClick={() => setMobileMenuOpen(false)}
						...
						<div className="flex-1 overflow-y-auto py-6 space-y-2">
							{navLinks.map((link) => (
								<a
									...
									href={link.href}
									onClick={() => setMobileMenuOpen(false)}
									className={`block px-4 py-3 rounded-xl text-base font-semibold transition-all ${activeSection === link.href.slice(1)
						...
						<div className="pt-6 border-t border-slate-100 space-y-4">
							<a
								href="tel:+919876543210"
								className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border border-slate-200 text-slate-700 font-semibold text-sm hover:bg-slate-50"
							>
							...
							<button
								...
								className="w-full py-3 bg-primary text-white font-bold text-sm rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-primary/20"
							>
								<Calculator className="w-4 h-4" /> Get a Quote
							</button>
						</div>
