				...
				{mobileMenuOpen && (
					<>
						...
						<motion.div
							...
							className="fixed top-0 right-0 bottom-0 w-[320px] bg-white z-50 shadow-2xl p-6 flex flex-col"
						>
							...
							<div className="mt-6 flex flex-col gap-2 flex-1">
								...
								{navLinks.map((item) => (
									...
									<NavLink
										...
										className={({ isActive }) =>
											`px-4 py-3 rounded-xl text-base font-medium transition ${isActive
