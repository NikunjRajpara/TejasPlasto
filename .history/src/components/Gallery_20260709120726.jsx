					...
					<AnimatePresence mode="popLayout">
						{[...filteredItems, ...filteredItems].map((item, index) => (
							<motion.div
								...
								className="group relative flex-shrink-0 w-[320px] sm:w-[360px] lg:w-[420px] h-80 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md hover:shadow-xl transition-all cursor-pointer snap-center"
								id={`gallery-item-${item.id}`}
							>
								<img
									src={item.image}
									alt={item.title}
									className="w-full h-full object-contain group-hover:whileHover={{ y:-8, scale:1.02}} transition-transform duration-500"
