        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12" id="footer-columns">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
              Tejas Plasto manufactures premium, durable, UV-protected, 100% food-grade water storage containment systems. Providing water security to homes, fields, and factories since 2011.
            </p>
