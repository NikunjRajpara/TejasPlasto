...
${message}`;
	...
	return (
		<section
			id="contact"
			className="py-13 bg-white relative overflow-hidden"
		>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
					...
					<p className="text-slate-600">
						Get in touch for water storage tanks, Rotomoulding powder, bulk orders or customized storage solutions. We respond within a few working hours.
					</p>
				</div>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								...
								<div className="space-y-1">
									...
									>
										...
										<option>Rotomoulding Powder</option>
