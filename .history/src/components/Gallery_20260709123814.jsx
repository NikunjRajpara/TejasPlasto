					...
					<div className="gallery-track">
						...
						{[...filteredItems, ...filteredItems].map((item, index) => (
							...
							>
								...
								{/* Dark Overlay */}
								<div
									className="absolute inset-0 bg-black/35 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
								/>

								{/* Zoom Icon */}
								<div
									className="absolute top-4 right-4 bg-white/20 backdrop-blur-md p-2 rounded-xl text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
								>
								...
								{/* Caption */}
								<div
									className="absolute bottom-0 left-0 right-0 p-5 text-white translate-y-5 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300"
								>
