      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600">
            Reach out for custom designs, volume dealer pricing, bulk construction project quotes, or retail inquiries. We reply within 12 working hours.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 justify-between">
            <div className="space-y-6 bg-slate-900 text-white p-6 sm:p-8 rounded-3xl relative overflow-hidden shadow-xl" id="contact-info-card">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-xs">Direct channels to Ahmedabad manufacturing operations</p>
              </div>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-xs text-slate-300">
                    ...
                    Tejas Plasto Manufacturing Unit, Phase II, GIDC Industrial Estate, Vatva, Ahmedabad, Gujarat, India - 382445
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-xs text-slate-300">
                    <strong className="text-white text-sm block mb-1">Telephone Hotlines</strong>
                    +91 98986 25850 <br />
                    +91 82002 98907
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-xs text-slate-300">
                    ...
                    contact@tejasplasto.com <br />
                    sales@tejasplasto.com
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-xs text-slate-300">
                    ...
                    <span className="text-rose-400">Sundays & Public Holidays Closed</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-white/10">
                <a
                  href="https://wa.me/919876543210?text=Hello%20Tejas%20Plasto%20Team,%20I%20have%20a%20commercial%20water%20storage%20tank%20requirement."
                  target="_blank"
                  rel="noreferrer"
