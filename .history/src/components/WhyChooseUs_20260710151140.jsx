...
export default function WhyChooseUs() {
	...
	return (
		<section id="why-us" className="py-13 bg-white relative overflow-hidden">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
					<span className="text-sm font-bold text-primary uppercase tracking-widest block">THE TEJASH PLASTO EDGE</span>
					<h2 className="text-3xl sm:text-4xl font-display font-extrabold text-slate-900 tracking-tight">
						Excellence Engineering. Ultimate Liquid Safety.
					</h2>
