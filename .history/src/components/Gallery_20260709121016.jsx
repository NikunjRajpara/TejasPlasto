					...
					<AnimatePresence mode="popLayout">
						{[...filteredItems, ...filteredItems].map((item, index) => (
							<motion.div
								...
								className="group relative w-[320px] sm:w-[360px] lg:w-[420px] h-80 flex-shrink-0 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md hover:shadow-2xl transition-all cursor-pointer "
