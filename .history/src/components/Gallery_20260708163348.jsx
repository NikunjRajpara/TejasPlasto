					...
					<AnimatePresence mode="popLayout">
						{filteredItems.map((item, index) => (
							<motion.div
								...
								className="group relative h-72 overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-100 shadow-sm hover:shadow-xl transition-all cursor-pointer"
