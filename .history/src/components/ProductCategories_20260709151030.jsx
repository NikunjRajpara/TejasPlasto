				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="products-grid">
					{PRODUCTS.map((product) => (
						<motion.div
							...
							className="glass-card rounded-2xl border border-slate-100 overflow-hidden shadow-md hover:shadow-2xl transition-all flex flex-col group"
						>
							{/* Product Image */}
							<div className="relative h-80 flex items-center justify-center glass-card overflow-hidden">
								<img
									src={product.image}
									alt={product.name}
