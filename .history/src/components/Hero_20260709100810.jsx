							...
							<div className="grid grid-cols-2 gap-4">
								...
								<div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 hover:border-primary/30 transition-all">
									...
									<p className="text-xs text-slate-600">
										Durable, UV-protected and leak-resistant storage solutions for homes, farms and industries.
									</p>
								</div>
								...
								<div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 hover:border-primary/30 transition-all">
									...
									<p className="text-xs text-slate-600">
										High-quality rotational moulding powder delivering smooth finish and consistent performance.
									</p>
								</div>
					...
					<div className="lg:col-span-5 flex items-stretch">
						<div className="w-full bg-white rounded-3xl border border-slate-200 p-3 shadow-sm relative overflow-hidden flex flex-col justify-center" id="hero-bento-right">
							...
							<motion.div
								...
								className="relative w-full h-[520px] sm:h-[560px] lg:h-[600px] rounded-2xl overflow-hidden bg-white flex items-center justify-center"
